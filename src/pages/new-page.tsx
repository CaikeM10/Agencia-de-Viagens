...
export default function NewPage() {
    ...
    const slides = [
        ...
        },
        {
            ...
            backgroundImage: '/images/bali3.jpg',
        ...
        },
        {
            ...
            backgroundImage: '/images/bali4.jpg',
            pageBackground: '/images/bali4.jpg',
        },
        {
            title: 'Tokyo',
            description:
                'Tokyo é uma cidade incrível e cheia de cultura e história.',
            backgroundImage: '/images/tokyo.jpg',
